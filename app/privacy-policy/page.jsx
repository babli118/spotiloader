      ...
      <div className="mx-10 sm:mx-[12rem] md:mx-[25rem] text-white ">
        <div>
          ...
          <p>
            ...
            that they shared and/or collect in Spotify Downloader. This policy
        ...
        <div>
          ...
          <p className="my-6">
            ...
            advertising partners of Spotify Downloader.
          </p>
          <p className="my-6">
            Third-party ad servers or ad networks uses technologies like
            cookies, JavaScript, or Web Beacons that are used in their
            respective advertisements and links that appear on Spotify
            Downloader, which are sent directly to users browser. They
          ...
          <p className="my-6">
            Note that Spotify Downloader has no access to or control over these
        ...
        <div>
          ...
          <p className="my-6">
            Spotify Downloader&apos;s Privacy Policy does not apply to other
        ...
        <div>
          ...
          <p className="my-6">
            Spotify Downloader does not knowingly collect any Personal
