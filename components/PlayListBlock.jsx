...
//           <div key={index}>
//             <div className="bg-primary/20 my-4 flex items-center justify-between  px-4 rounded-md  ">
//               <div className="flex justify-center items-center  ">
//                 <div className=" flex">
...
const PlayListBlock = ({ playlist, resetState, download }) => {
  ...
  return (
    <div className="w-full">
      ...
      <div className="text-text pt-4 w-full">
        {tracks.map((track, index) => (
          <div key={index}>
            <div className="bg-text/10 my-4 flex items-center shadow-sm  justify-between  px-4 rounded-md   w-[95vw] md:w-[80vw] xl:w-[43vw] ">
              <div className="flex justify-center items-center  ">
                <div className=" flex">
                  <div className="pr-4 text-lg flex  ">
                    <p>{index + 1}</p> <span>.</span>{" "}
                ...
                <div className="flex flex-col justify-center py-4   ">
                  ...
                  <p className="text-sm font-medium  pr-4">{track.artist}</p>
                </div>
              </div>
              <div
                onClick={(e) => {
                ...
                disabled={downloadStatus[index]} // Here, we directly use the disabled attribute
                className="flex flex-col items-center justify-center cursor-pointer sm:w-[150px]  hover:bg-[#3e8f5a]  disabled:bg-[#3e8f5a] transition-all bg-primary rounded-md   "
              >
                <button
                  disabled={downloadStatus[index]} // Here, we directly use the disabled attribute
                  id={index}
                  className="flex items-center justify-center  text-grey font-bold  text-text text-4xl  ml-2 transition-all py-2 px-4  "
                >
                  {downloadStatus[index] ? (
                    <TailSpin
                      visible={true}
